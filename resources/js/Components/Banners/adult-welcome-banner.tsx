...
export function AdultWelcomeBanner() {
    ...
    return (
        <div className="relative overflow-hidden bg-white dark:bg-slate-900 rounded-[2rem] sm:rounded-[2.5rem] border-[3px] sm:border-[4px] border-slate-200 dark:border-slate-800 shadow-[0_6px_0_#cbd5e1] sm:shadow-[0_8px_0_#cbd5e1] dark:shadow-[0_6px_0_#0f172a] sm:dark:shadow-[0_8px_0_#0f172a] mb-6 sm:mb-8 text-center transition-all">
            {/* Abstract background graphics */}
            <div className="absolute inset-0 z-0 overflow-hidden">
                <div className="absolute top-0 right-0 w-[30rem] sm:w-[40rem] h-[30rem] sm:h-[40rem] bg-orange-500/10 dark:bg-orange-500/5 rounded-full -mr-20 sm:-mr-32 -mt-20 sm:-mt-32"></div>
                <div className="absolute bottom-0 left-0 w-[20rem] sm:w-[30rem] h-[20rem] sm:h-[30rem] bg-blue-500/10 dark:bg-blue-500/5 rounded-full -ml-16 sm:-ml-20 -mb-16 sm:-mb-20"></div>
            ...
            <div className="relative z-10 px-4 py-6 sm:px-10 sm:py-10 flex flex-col items-center">
                ...
                <h1 className="text-2xl sm:text-4xl md:text-5xl font-black text-slate-800 dark:text-white mb-2 sm:mb-3 tracking-tight drop-shadow-sm dark:drop-shadow-xl transition-colors">
                    Welcome home, <span className="text-orange-500 dark:text-orange-400 drop-shadow-[0_2px_10px_rgba(249,115,22,0.2)] dark:drop-shadow-[0_2px_10px_rgba(251,146,60,0.4)]">{firstName}</span>!
                </h1>
                ...
                <div className="flex flex-row flex-wrap justify-center gap-2 sm:gap-3 w-auto px-2 sm:px-0">
                    <span className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3.5 py-1.5 sm:px-5 sm:py-2.5 rounded-full bg-white dark:bg-white/10 border-[2px] border-slate-200 dark:border-white/20 text-slate-700 dark:text-white text-[10px] sm:text-xs md:text-sm font-black tracking-wide shadow-sm dark:shadow-xl transition-all hover:bg-slate-50 dark:hover:bg-white/20 whitespace-nowrap">

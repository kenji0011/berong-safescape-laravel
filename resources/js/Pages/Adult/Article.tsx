            ...
            <main className="w-full relative z-10 pt-2 sm:pt-4 pb-24 sm:pb-32">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-2 sm:mb-3 flex items-center justify-between gap-3 relative z-20">
                    <Link 
                        ...
                        className="inline-flex items-center gap-1.5 sm:gap-2 px-3.5 py-1.5 sm:px-4 sm:py-2 bg-white/95 dark:bg-slate-800/95 backdrop-blur-md rounded-full text-slate-700 dark:text-slate-200 font-bold hover:text-orange-600 dark:hover:text-orange-400 border-2 border-slate-200 dark:border-slate-700 hover:border-orange-500/50 dark:hover:border-orange-500/50 shadow-sm transition-all text-xs sm:text-sm"
                    >

        ...
        <div className="min-h-screen selection:bg-red-500 selection:text-white pb-24 relative">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 relative z-10">
                ...
                <div className="mb-8 flex items-center justify-between">
                    <Link 
                        href="/adult" 
                        className="inline-flex items-center gap-2 px-5 py-2.5 bg-white rounded-full text-slate-700 font-bold hover:text-slate-900 border-2 border-slate-200 border-b-[4px] active:border-b-2 active:translate-y-[2px] shadow-sm transition-all text-sm"
                    >
                ...
                <article className="bg-white rounded-[2rem] sm:rounded-[3rem] shadow-[0_8px_30px_rgba(0,0,0,0.06)] border-2 border-slate-100 overflow-hidden">
                    
                    {/* Header Section */}
                    <div className="p-6 sm:p-8 md:p-10 pb-6 sm:pb-8 bg-gradient-to-b from-slate-50/80 to-white">
                        <span className="inline-block px-3 py-1 bg-orange-100 text-orange-600 font-black text-[10px] uppercase tracking-widest rounded-full border-2 border-orange-200 mb-4 shadow-sm">
                            Fire Safety Education
                        </span>
                        
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-800 leading-[1.2] tracking-tight mb-6">
                            {blog.title}
                        </h1>
                        
                        <div className="flex flex-wrap items-center gap-4 text-slate-500">
                            <div className="flex items-center gap-3">
                                <div className="h-10 w-10 rounded-full bg-orange-100 flex items-center justify-center border-2 border-white shadow-sm shrink-0">
                                    <User className="h-5 w-5 text-orange-600" />
                                </div>
                                <div className="text-left py-1">
                                    <div className="font-bold text-slate-800 text-[14px] leading-tight">{authorName}</div>
                    ...
                    {blog.imageUrl && (
                        <div className="px-5 sm:px-8 md:px-10">
                            <div 
                                className="w-full relative group cursor-zoom-in rounded-3xl overflow-hidden shadow-sm border-2 border-slate-100 bg-slate-50 ring-offset-2 transition-all hover:ring-4 hover:ring-orange-100 active:scale-[0.99]"
                                onClick={() => setIsImageExpanded(true)}
                            >
                                <img 
                                    src={blog.imageUrl} 
                                    alt={blog.title} 
                                    className="w-full h-auto max-h-[300px] object-contain object-center transition-transform duration-500 group-hover:scale-[1.02]"
                                />
                                ...
                                <div className="absolute inset-0 bg-slate-900/0 group-hover:bg-slate-900/10 transition-colors duration-300 flex items-center justify-center">
                                    <div className="opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300 bg-white/90 backdrop-blur-sm text-slate-800 font-bold px-4 py-2 rounded-full flex items-center gap-2 shadow-lg">
                    ...
                    {/* Article Content */}
                    <div className="p-6 sm:p-8 md:p-10 pt-8 sm:pt-10 relative">
                        <div 
                            className="prose prose-slate max-w-none 
                                ...
                                prose-p:text-slate-600 prose-p:font-medium prose-p:leading-relaxed prose-p:mb-5 prose-p:text-sm lg:prose-p:text-base
                                ...
                                prose-ul:marker:text-orange-400 prose-li:font-medium prose-li:text-sm lg:prose-li:text-base
                                prose-img:rounded-3xl prose-img:shadow-md border-slate-100"
                ...
                {/* Emergency Protocol */}
                <div className="mt-8 overflow-hidden rounded-[2rem] bg-[#fff5f5]/95 backdrop-blur-sm border-2 border-red-100 p-6 sm:p-8 shadow-sm">
                    <div className="flex flex-col sm:flex-row gap-5 items-start sm:items-center">
                        <div className="h-16 w-16 rounded-full bg-white flex items-center justify-center shrink-0 shadow-sm border border-red-50">
                            <Flame className="h-7 w-7 text-red-600" />
                        </div>
                        <div className="flex-1">
                            <h3 className="text-[1.35rem] font-black text-red-950 mb-2">Emergency Protocol</h3>

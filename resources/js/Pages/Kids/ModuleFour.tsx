    ...
    try {
      ...
      const resizeIframe = () => {
        requestAnimationFrame(() => {
          ...
          // Save parent scroll position before collapsing
          const savedScrollY = window.scrollY;
          // Collapse to 0 so scrollHeight reports true content height
          iframe.style.height = '0px';
          const height = iframeDoc.documentElement.scrollHeight;
          iframe.style.height = `${height}px`;
          // Restore scroll position so there's no visible jump

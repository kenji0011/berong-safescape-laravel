        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="relative mb-12 group">
            ...
            <div className="relative bg-white rounded-[2rem] p-6 sm:p-8 shadow-xl border-2 border-slate-50 overflow-hidden">
               ...
               <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-red-50 rounded-full blur-2xl opacity-60"></div>
               ...
               <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 relative z-10">
                  ...
                  >
                     <ArrowLeft className="h-6 w-6 text-slate-600 group-hover/btn:text-red-600 transition-colors" />
                  </Link>
          ...
          <div ref={playerRef} className="relative mb-16 group/player animate-in fade-in zoom-in duration-700">
            ...
            <div className="relative bg-slate-900 rounded-[2.5rem] border-[8px] border-slate-800 shadow-2xl overflow-hidden">
          ...
          <div className="mb-20">
            <div className="flex items-center justify-between mb-10">
               <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-red-500 rounded-2xl flex items-center justify-center shadow-lg shadow-red-200 rotate-3 group-hover:rotate-0 transition-transform">
                     <Play className="h-6 w-6 text-white fill-current" />
                  </div>
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-black text-slate-800 tracking-tight">Mission Briefings</h3>
                    <p className="text-slate-500 font-bold text-sm uppercase tracking-widest">Select a target to begin training</p>
                  </div>
               </div>
            </div>
              ...
              {moreVideos.map((video) => {
                ...
                return (
                  <div 
                    ...
                    className={cn(
                      "group relative flex flex-col bg-white rounded-[2.5rem] overflow-hidden transition-all duration-500 cursor-pointer h-full border-2",
                      isActive 
                        ? "border-red-500 shadow-2xl shadow-red-200 scale-[1.02] z-10" 
                        : "border-slate-50 shadow-xl hover:shadow-2xl hover:border-red-200 hover:-translate-y-2"
                    )}
                  >
                    ...
                    <div className="relative w-full h-48 sm:h-52 overflow-hidden">
                       ...
                       <div className={cn(
                         ...
                         isActive ? "opacity-100" : "opacity-0 group-hover:opacity-100"
                          ...
                          <div className="w-16 h-16 rounded-full bg-red-600/90 backdrop-blur-sm border-4 border-white flex items-center justify-center shadow-2xl transform transition-transform group-hover:scale-110">
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      {isActive && (
                        <div className="mt-6 w-full bg-red-600 text-white font-black text-[10px] py-3 rounded-2xl shadow-lg shadow-red-200 flex items-center justify-center gap-2 tracking-[0.2em] uppercase animate-pulse">
          ...
          <div className="relative group/footer">
            ...
            <div className="relative overflow-hidden bg-white rounded-[2.5rem] p-8 sm:p-12 border-2 border-amber-50 shadow-2xl text-center">
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-amber-100/50 rounded-full blur-3xl"></div>
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-red-100/30 rounded-full blur-3xl"></div>
              
              <div className="relative z-10 flex flex-col items-center">
                <div className="h-20 w-20 bg-amber-500 border-4 border-white rounded-[2rem] shadow-xl flex items-center justify-center mb-8 transform rotate-3 group-hover/footer:rotate-12 transition-transform duration-500">
                  <Star className="h-10 w-10 text-white fill-white" />
                </div>
                <h3 className="text-slate-800 text-3xl sm:text-4xl font-black mb-4 tracking-tight">Great Job, Hero! 🌟</h3>
                <p className="text-slate-500 font-bold text-lg max-w-lg leading-relaxed mb-8">
                  Every video you watch adds to your hero knowledge. Keep training to earn your master badge!
                </p>
                <Link 
                  href="/kids/challenges"
                  className="px-10 py-4 bg-slate-900 text-white rounded-full font-black text-sm tracking-widest uppercase hover:bg-slate-800 hover:-translate-y-1 transition-all shadow-xl active:scale-95 flex items-center gap-3"
                >

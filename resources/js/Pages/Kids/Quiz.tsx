...
const quizData = {
  easy: [
    { text: "What should you do if your clothes catch on fire?", options: ["Run fast", "Stop, Drop, and Roll", "Jump up and down"], correctAnswer: "Stop, Drop, and Roll", explanation: "Stop, Drop, and Roll helps put out the flames on your clothes!" },
    { text: "What is the very first thing you do if you hear a fire alarm?", options: ["Hide in the closet", "Get out safely and quickly", "Look for the fire"], correctAnswer: "Get out safely and quickly", explanation: "Always prioritize getting out safely and quickly over material items!" },
    { text: "When escaping a fire, if there is smoke, you should...", options: ["Crawl low under the smoke", "Run fast and breathe deep", "Walk normally"], correctAnswer: "Crawl low under the smoke", explanation: "Smoke rises naturally, so crawling low keeps you in the cleanest air." },
    { text: "Who should you call if there is a fire?", options: ["Your friends", "Ghostbusters", "911 / Emergency Number"], correctAnswer: "911 / Emergency Number", explanation: "911 or your local emergency number will send the fire department to help you right away." },
    { text: "Should you ever hide from firefighters?", options: ["Yes, they look scary", "No, they are there to help you!", "Sometimes"], correctAnswer: "No, they are there to help you!", explanation: "Firefighters wear masks and heavy gear that might look scary, but they are your friends there to save you." }
  ],
  medium: [
    { text: "What is the best way to check if a closed door is safe to open during a fire?", options: ["Touch the doorknob with your palm", "Use the back of your hand to feel the door", "Kick the door open"], correctAnswer: "Use the back of your hand to feel the door", explanation: "The back of your hand is very sensitive to heat and won't get burned as easily as your palm." },
    { text: "How often should you test the smoke alarms in your home?", options: ["Once a year", "Once a month", "Only when they beep"], correctAnswer: "Once a month", explanation: "Testing smoke alarms once a month ensures they are always ready to protect you." },
    { text: "What is an EDITH plan?", options: ["Emergency Door In The House", "Exit Drills In The Home", "Every Dog Is Trained to Help"], correctAnswer: "Exit Drills In The Home", explanation: "EDITH stands for Exit Drills In The Home, which means practicing your escape plan!" },
    { text: "Where is the safest place to meet your family after escaping a fire?", options: ["In the living room", "A pre-arranged meeting spot outside", "In the car"], correctAnswer: "A pre-arranged meeting spot outside", explanation: "Having a specific meeting spot outside like a mailbox or tree ensures everyone is accounted for safely." },
    { text: "If a small pan catches fire while cooking, what is the safest thing to do?", options: ["Throw water on it", "Blow on it", "Cover it with a lid to smother the fire"], correctAnswer: "Cover it with a lid to smother the fire", explanation: "Covering the pan removes the oxygen the fire needs to burn. Never use water on a grease fire!" }
  ],
  hard: [
    { text: "If you find matches or a lighter lying around, what is the safest thing to do?", options: ["Hide them so no one else finds them", "Leave them alone and tell an adult right away", "Try to light one outside"], correctAnswer: "Leave them alone and tell an adult right away", explanation: "Matches and lighters are tools for adults, not toys. Always let an adult handle them safely." },
    { text: "What should you do if your favorite pet or toy is left inside a burning building?", options: ["Run back inside quickly to get them", "Cry and wait by the door", "Never go back inside; tell a firefighter right away"], correctAnswer: "Never go back inside; tell a firefighter right away", explanation: "Firefighters are trained and have special gear to rescue pets. You should never go back inside a burning building for any reason!" },
    { text: "When you call 911 or your local emergency number, what is the most important information to give them?", options: ["Your favorite color", "Your name, address, and what the emergency is", "The time of day"], correctAnswer: "Your name, address, and what the emergency is", explanation: "The operator needs to know exactly where you are and what is happening so they can send the right help immediately." },
    { text: "Why is it important to close doors behind you when escaping a fire?", options: ["So robbers can't get in", "To slow down the fire and smoke from spreading", "To keep your pets inside"], correctAnswer: "To slow down the fire and smoke from spreading", explanation: "Closing doors cuts off oxygen to the fire and creates a barrier against smoke, giving you more time to escape." },
    { text: "If there is a fire and you are trapped in your room, what should you do?", options: ["Hide under the bed or in the closet", "Open the window and wave a bright cloth while yelling for help", "Try to run through the fire"], correctAnswer: "Open the window and wave a bright cloth while yelling for help", explanation: "Never hide! Go to a window, yell loudly, and wave a bright cloth so firefighters can easily find and rescue you." }
  ]
};
...
const QuizPage = () => {
  ...
  if (isFinished) {
    ...
    return (
      <div className="-mt-[104px] sm:-mt-[120px] pt-[104px] sm:pt-[120px] min-h-screen w-full flex-1 flex items-center justify-center bg-blue-50 dark:bg-slate-950 p-4 pb-20 sm:p-8 sm:pb-32 relative overflow-hidden">
  ...
  return (
    <div className="-mt-[104px] sm:-mt-[120px] pt-[104px] sm:pt-[120px] min-h-screen relative flex flex-col font-sans bg-blue-50 dark:bg-slate-950 transition-colors duration-500 selection:bg-orange-300 selection:text-orange-900">
      ...
      <div className="relative z-10 w-full flex-1 flex flex-col py-4 pb-28 sm:pb-4">
        ...
        <div className="max-w-3xl mx-auto w-full px-4 sm:px-6 flex-1 flex flex-col pt-12 sm:pt-0 mb-8">
          
          <div className="flex flex-col w-full bg-white dark:bg-slate-900 border border-white/60 dark:border-slate-800/60 rounded-[2.5rem] p-5 sm:p-8 shadow-[0_25px_60px_rgba(234,88,12,0.15)] transition-colors duration-500 relative">
